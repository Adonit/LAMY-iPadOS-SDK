...
#import "LamyColorView.h"
#import "LamyLineWidthView.h"
#import "LamySDK.h"
#import "LamyPrototypeOverlayViewController.h"

#pragma mark - Enums

NSString * const LamyStylusScrollRawValueUpdated = @"lamyStylusScrollRawValueUpdated";
NSString * const LamyStylusScrollPositionUpdated = @"lamyStylusScrollPositionUpdated";
NSString * const LamyStylusScrollValue = @"lamyStylusScrollValue";
NSString * const LamyStylusScrollVelocity = @"LamyStylusScrollVelocity";
NSString * const LamyStylusScrollSwipeUp = @"LamyStylusScrollSwipeUp";
NSString * const LamyStylusScrollSwipeDown = @"LamyStylusScrollSwipeDown";
NSString * const LamyStylusScrollTouchDown = @"lamyStylusScrollTouchDown";
NSString * const LamyStylusScrollTouchUp = @"lamyStylusScrollTouchUp";
NSString * const LamyStylusScrollTapCount = @"LamyStylusScrollTapCount";
NSString * const LamyStylusScrollTapNotification = @"LamyStylusScrollTapNotification";
NSString * const LamyStylusScrollTapPosition = @"LamyStylusScrollTapPosition";
...
@interface LamyPrototypeViewController ()
{
...
@implementation LamyPrototypeViewController
...
//    self.doubleTapBackAction = Double_Tap_Back_Option_Opacity_Adjust;
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updateLabelWithTouchDetected:) name:LamyStylusScrollTouchDown object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(updateLabelWithTouchNotDetected) name:LamyStylusScrollTouchUp object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(scrollTapDetected:) name:LamyStylusScrollTapNotification object:nil];
...
{
    [[NSNotificationCenter defaultCenter] removeObserver:self name:LamyStylusScrollRawValueUpdated object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:LamyStylusScrollSwipeUp object:nil];
    [[NSNotificationCenter defaultCenter] removeObserver:self name:LamyStylusScrollSwipeDown object:nil];
    
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(scrollSwipeUp:) name:LamyStylusScrollSwipeUp object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(scrollSwipeDown:) name:LamyStylusScrollSwipeDown object:nil];
    switch (self.prototypeMode) {
        case Prototype_Mode_Relative:
        {
            [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(handleScrollPosition:) name:LamyStylusScrollRawValueUpdated object:nil];
        }
            break;
...
{
    lastScrollTouchPosition = [[touchDownNotification.userInfo objectForKey:LamyStylusScrollValue] floatValue];
...
{
    NSNumber *scrollNumber = [scrollNotification.userInfo objectForKey:LamyStylusScrollValue];
...
- (void)scrollTapDetected:(NSNotification *)tapNotification
{
    ...
    NSInteger numberOfTapsFromSDK = [userInfo[LamyStylusScrollTapCount] integerValue];
    CGFloat positionOfTap = [userInfo[LamyStylusScrollTapPosition] floatValue];
