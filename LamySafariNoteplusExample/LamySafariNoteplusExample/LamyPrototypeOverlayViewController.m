...
#import "LamyVerticalSliderView.h"
#import "LamySelectionView.h"

@interface LamyPrototypeOverlayViewController()
@property (weak, nonatomic) IBOutlet LamyLineWidthView *brushSizeView;
@property (weak, nonatomic) IBOutlet LamyColorView *brushColorView;
@property (weak, nonatomic) IBOutlet LamyVerticalSliderView *colorSlider;
@property (weak, nonatomic) IBOutlet LamyVerticalSliderView *sizeSlider;

@property (weak, nonatomic) IBOutlet UILabel *tapButton1Label;
@property (weak, nonatomic) IBOutlet UILabel *tapButton2Label;

@property LamySelectionView *colorSelectionView;
@property LamySelectionView *toolSelectionView;

@end

@implementation LamyPrototypeOverlayViewController
...
{
    return [LamySelectionView selectionViewSizeForNumberOfItems:numberOfItems];
}
...
- (void)setToolUnselectedViews:(NSArray *)unselectedViews selectedViews:(NSArray *)selectedViews
{
    ...
    self.toolSelectionView = [[LamySelectionView alloc]initWithUnselectedViews:unselectedViews selectedViews:selectedViews];
...
- (void)setColorUnselectedViews:(NSArray *)unselectedViews selectedViews:(NSArray *)selectedViews
{
    ...
    self.colorSelectionView = [[LamySelectionView alloc]initWithUnselectedViews:unselectedViews selectedViews:selectedViews];
