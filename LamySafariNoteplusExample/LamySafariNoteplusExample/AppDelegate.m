...
{
    [[NSNotificationCenter defaultCenter] addObserverForName:LamyStylusManagerDiscoveryAttemptedButBluetoothOffNotification object:nil queue:[NSOperationQueue mainQueue] usingBlock:^(NSNotification *note) {
