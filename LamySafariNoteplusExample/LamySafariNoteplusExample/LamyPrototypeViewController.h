...
@class LamyPrototypeOverlayViewController;
...
@interface LamyPrototypeViewController : UIViewController

@property (nonatomic, weak) id <PrototypeBrushAdjustments> delegate;
@property (nonatomic, weak) LamyPrototypeOverlayViewController *overLayController;
